...
encodings agree and where they differ:
\begin{center}
\begin{tabular}{lll}
...
$\bigcup n = \mathrm{pred}(n)$ for $n>0$?\footnote{Here $\mathrm{pred}(n)$ denotes the ordinal predecessor: the unique $m$ with $m^+ = n$.} & true & true \\
